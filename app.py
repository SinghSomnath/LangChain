...
st.write("This app allows you to upload a PDF document, ask questions about its content, and maintain a chat history for context.")
...
## Statefully manage the chat history
    ...
    if splits:
        ...
        st.warning("No documents found to index. Please upload at least one PDF.")
        st.stop()
